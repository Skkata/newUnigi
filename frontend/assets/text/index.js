import Landing from "../../pages/service/landing";
...
export const textRU = {
    ...
    landingPage:{
        ...
        service: 'Услуги',
        home: 'Главная меню',
        caption: 'Вам нужен продающий Landing Page под ключ?',
        p: 'Лендинг может разрабатываться и как подкрепление к уже существующему сайту и бизнесу, и в качестве самостоятельного сайта по продаже Ваших товаров или услуг',
        one: 'Что входит в создание Лендинг Пейдж?',
        two: 'Мы гарантируем',

        text    :[
            {
                id: 'one',
                description: 'Landing Page – это сайт-одностраничник, который должен эффективно продавать! Его дизайн разработан специальным образом, что позволяет достигнуть максимально высокой конверсии посетителей в покупатели.',

            },
            {
                id: 'two',
                description: 'Мы, как профессионалы своего дела, знаем, что нужно сделать, чтобы лендинг был эффективным и прибыльным инструментом Вашего бизнеса.',

            },

            {
                id: 'three',
                description: 'Главная задача лендинга – заинтересовать посетителя, дать ответ на вопрос, с которым он пришел на сайт, а также «зацепить» его внимание и вызвать у него желание заказать услугу или товар.',

            },

            {
                id: 'four',
                description: 'Мы предлагаем индивидуальный подход к каждому проекту — изучаем сферу бизнеса и предлагаем наиболее выгодные для Вас решения.',
        ...
        buttom:{
            one:[
                {
                    id: 'one',
                    pros: 'Анализ сферы и определение конкурентных преимуществ'
                },
                {
                    id: 'two',
                    pros: 'Разработка уникального или индивидуального дизайна'
                },
                {
                    id: 'three',
                    pros: 'Настройка CMS для управления и верстка сайта'
                },
                {
                    id: 'four',
                    pros: 'Наполнение страницы материалами, подготовка контента и его публикация'
                },
                {
                    id: 'five',
                    pros: 'Разработка рекламной стратегии для получения лучшего результата'
                },
            ],
            two:[
                {
                    id: 'one',
                    pros: 'Безупречные технические решения'
                },
                {
                    id: 'two',
                    pros: 'Продающий дизайн'
                },
                {
                    id: 'three',
                    pros: 'Честные цены'
                ...
                {
                    id: 'four',
                    pros: 'Разумные сроки реализации'
                },
                {
                    id: 'five',
                    pros: 'Техническую поддержку после сдачи проекта'
                },
            ]
